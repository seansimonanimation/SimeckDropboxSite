...
if(isset($_POST['See_Project'])){
    ...
    $CurrentProjectData = GetAllDataForProject(GetAssignedVendorProjectOptionList()[0]['pid'] ?? '');
    $currentVendorPid = $CurrentProjectData['project']['pid'] ?? '';
...
<div class="module">
    <div class="module-header">
        <h1 class="module-title">Project Comments</h1>
        <br />
    </div>
    <div class="module-grid">
        <div class="module-card module-card--placeholder"></div>
        <div class="module-card module-card--span-2"><Center><h1>Current Project</h1><h3> <?php echo htmlspecialchars($CurrentProjectData['project']['project_name'] ?? ''); ?></h3> </Center></div>
        <div class="module-card module-card--placeholder"></div>
                ...
                <form method="post" action="index.php">
                    <label class="module-form-group" style="margin-bottom:12px;">
                        <select name="See_Project" id="project-select" class="module-input" style="width:auto;min-width:200px;" onchange="this.form.submit()">
                                ...
                                <?php GetAssignedVendorProjectOptionListHTML(); ?>
                        </select>
                    </label>
                </form>
            </div>

...
elFinder.prototype._options = {
	...
	contextmenu : {
		...
		files  : ['seecm' , '|' ,'sendToMondayChat', 'sendToThursdayChat',  '|' ,'getfile', '|' ,'open', 'opennew', 'download', 'opendir', 'quicklook', '|', 'upload', 'mkdir', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', 'empty', '|', 'rename', 'edit', '|', 'archive', 'extract', '|']
	},

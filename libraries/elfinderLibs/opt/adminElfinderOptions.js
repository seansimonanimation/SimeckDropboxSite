...
commands : ['*', 'seeComments', 'lockFile', 'rm', 'sendToDiscord', 'CopyDirectLink' , 'CopyLinkToFolder' , 'mv'],
	...
	contextmenu : {
		...
		files  : ['seeComments' , '|' ,'sendToDiscord',  'lockFile' ,'|' , 'getfile', '|' , 'CopyDirectLink' , 'CopyLinkToFolder' , '|', 'open', 'opennew', 'download', 'opendir', 'quicklook', '|', 'upload', 'mkdir', '|', 'copy', 'cut', 'paste', '|' , 'mv' , 'duplicate', '|', 'rm', 'empty', 'hide', '|', 'rename', 'edit', 'resize', '|', 'archive', 'extract', '|', 'selectall', 'selectinvert', '|', 'places', 'info', 'chmod', 'netunmount']
	},

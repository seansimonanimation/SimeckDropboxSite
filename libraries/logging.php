...
function LogAction( $user_action, $extra_data, $project_target){
    $pdo = DBConnect();
    $stmt = $pdo->prepare("INSERT INTO logs (username, user_action, ip_address, extra_data, project_target, log_time, impersonated_by) VALUES (?, ?, ?, ?, ?, NOW(), ?)");
